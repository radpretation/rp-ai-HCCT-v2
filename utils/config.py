...
parser.add_argument('--train_folder'   ,default='/home/common/IXI_synthetic_MRIs'        ,type=str, help="Train set data path ")
parser.add_argument('--valid_folder'   ,default='/home/common/IXI_synthetic_MRIs'       ,type=str, help="Validation set data path ")
parser.add_argument('--test_folder'    ,default='/home/common/IXI_synthetic_MRIs'        ,type=str, help="Test set data path ")
parser.add_argument('--mask_folder'    ,default='/home/common/IXI_synthetic_MRIs'         ,type=str, help="Mask set data path ")

parser.add_argument('--excel_path'     ,default='/home/jupyter-rishabh/rp-ai-Triamese-ViT-v2/IXI_SYNTHETIC.xlsx', type=str, help="Excel file path ")
