...
parser.add_argument('--train_folder'   ,default='/home/jupyter-rishabh/rp-ai-explainability-tools/Balancedmeanandstd_dataset/NTrain'         ,type=str, help="Train set data path ")
parser.add_argument('--valid_folder'   ,default='/home/jupyter-rishabh/rp-ai-explainability-tools/Balancedmeanandstd_dataset/NVal'         ,type=str, help="Validation set data path ")
parser.add_argument('--test_folder'    ,default='/home/jupyter-rishabh/rp-ai-explainability-tools/Balancedmeanandstd_dataset/NTest'          ,type=str, help="Test set data path ")
parser.add_argument('--mask_folder'    ,default='/home/jupyter-rishabh/rp-ai-explainability-tools/Balancedmeanandstd_dataset/NTest'          ,type=str, help="Mask set data path ")

parser.add_argument('--excel_path'     ,default='/home/jupyter-rishabh/rp-ai-explainability-tools/Balancedmeanandstd_dataset/Combined.xlsx',type=str, help="Excel file path ")
