...
parser.add_argument('--train_folder'   ,default='/home/jupyter-rishabh/rp-ai-brain-age-cross-validation/Folds_v4/fold_4/train'        ,type=str, help="Train set data path ")
parser.add_argument('--valid_folder'   ,default='/home/jupyter-rishabh/rp-ai-brain-age-cross-validation/Folds_v4/fold_4/val'       ,type=str, help="Validation set data path ")
parser.add_argument('--test_folder'    ,default='/home/jupyter-rishabh/rp-ai-brain-age-cross-validation/Folds_v4/fold_4/test'        ,type=str, help="Test set data path ")
parser.add_argument('--mask_folder'    ,default='/home/jupyter-rishabh/rp-ai-brain-age-cross-validation/Folds_v4/fold_4/test'         ,type=str, help="Mask set data path ")

parser.add_argument('--excel_path'     ,default='/home/jupyter-rishabh/rp-ai-brain-age-cross-validation/Combined_folds_xlsx/Combined_fold_4.xlsx', type=str, help="Excel file path ")
...
parser.add_argument('--batch_size'  ,default=12           ,type=int,   help="Batch size during training process")
