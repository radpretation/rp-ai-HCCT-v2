...
def test(valid_loader, model, criterion, device
    ...
    with torch.no_grad():
        ...
        # '/home/jupyter-rishabh/rp-ai-explainability-tools/Balancedmeanandstd_dataset/NTrain/NTrain/ABIDE_KKI_29320.nii.gz'
